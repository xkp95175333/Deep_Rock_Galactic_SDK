...
struct ABP_AsteroidField_C : AActor {
	...
	void UserConstructionScript(); // Function BP_AsteroidField.BP_AsteroidField_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x158ca90
	void ReceiveBeginPlay(); // Function BP_AsteroidField.BP_AsteroidField_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x158ca90
	void ExecuteUbergraph_BP_AsteroidField(int32_t EntryPoint); // Function BP_AsteroidField.BP_AsteroidField_C.ExecuteUbergraph_BP_AsteroidField // (Final|UbergraphFunction) // @ game+0x158ca90
};
