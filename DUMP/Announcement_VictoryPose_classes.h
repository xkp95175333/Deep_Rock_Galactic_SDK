...
struct UAnnouncement_VictoryPose_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function Announcement_VictoryPose.Announcement_VictoryPose_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x158ca90
	void Construct(); // Function Announcement_VictoryPose.Announcement_VictoryPose_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x158ca90
	void OnAnnounceAnimFinished(); // Function Announcement_VictoryPose.Announcement_VictoryPose_C.OnAnnounceAnimFinished // (BlueprintCallable|BlueprintEvent) // @ game+0x158ca90
	void ExecuteUbergraph_Announcement_VictoryPose(int32_t EntryPoint); // Function Announcement_VictoryPose.Announcement_VictoryPose_C.ExecuteUbergraph_Announcement_VictoryPose // (Final|UbergraphFunction) // @ game+0x158ca90
};
