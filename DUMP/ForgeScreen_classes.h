...
struct UForgeScreen_C : UUserWidget {
	...
	void Construct(); // Function ForgeScreen.ForgeScreen_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x158ca90
	void StartForging(); // Function ForgeScreen.ForgeScreen_C.StartForging // (BlueprintCallable|BlueprintEvent) // @ game+0x158ca90
	void FrogingDone(); // Function ForgeScreen.ForgeScreen_C.FrogingDone // (BlueprintCallable|BlueprintEvent) // @ game+0x158ca90
	void ExecuteUbergraph_ForgeScreen(int32_t EntryPoint); // Function ForgeScreen.ForgeScreen_C.ExecuteUbergraph_ForgeScreen // (Final|UbergraphFunction) // @ game+0x158ca90
};
