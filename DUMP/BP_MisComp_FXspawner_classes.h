...
struct ABP_MisComp_FXspawner_C : AActor {
	...
	void UserConstructionScript(); // Function BP_MisComp_FXspawner.BP_MisComp_FXspawner_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x158ca90
	void SetSurvived(bool Survived); // Function BP_MisComp_FXspawner.BP_MisComp_FXspawner_C.SetSurvived // (BlueprintCallable|BlueprintEvent) // @ game+0x158ca90
	void ExecuteUbergraph_BP_MisComp_FXspawner(int32_t EntryPoint); // Function BP_MisComp_FXspawner.BP_MisComp_FXspawner_C.ExecuteUbergraph_BP_MisComp_FXspawner // (Final|UbergraphFunction) // @ game+0x158ca90
};
