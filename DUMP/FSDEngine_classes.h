...
struct UCSGBake : UDataAsset {
	...
	void Bake(); // Function FSDEngine.CSGBake.Bake // (Final|Native|Public|BlueprintCallable) // @ game+0x8dc380
};
...
struct ACSGBuilderBase : AActor {
	...
	void PreGenerate(struct UBakeConfig* builder); // Function FSDEngine.CSGBuilderBase.PreGenerate // (Event|Public|BlueprintEvent) // @ game+0x158ca90
};
...
struct UBakeConfig : UObject {
	...
	struct FVector GetVectorSetting(struct FName Name, struct FVector defaultVal); // Function FSDEngine.BakeConfig.GetVectorSetting // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x320f980
	struct FRandomStream GetRandomStream(); // Function FSDEngine.BakeConfig.GetRandomStream // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x11f5de0
	struct UBuilderBase* GetObject(struct FName Name); // Function FSDEngine.BakeConfig.GetObject // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x320f8f0
	int32_t GetIntSetting(struct FName Name, int32_t defaultVal); // Function FSDEngine.BakeConfig.GetIntSetting // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x320f830
	float GetFloatSetting(struct FName Name, float defaultVal); // Function FSDEngine.BakeConfig.GetFloatSetting // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x320f760
	bool GetBoolSetting(struct FName Name, bool defaultVal); // Function FSDEngine.BakeConfig.GetBoolSetting // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x320f6a0
};
...
struct UDeepProceduralMeshComponent : UMeshComponent {
	...
	struct UTerrainMaterialCore* FindTerrainMaterialFromPhysicalMaterial(struct UPhysicalMaterial* Material); // Function FSDEngine.DeepProceduralMeshComponent.FindTerrainMaterialFromPhysicalMaterial // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x321ad90
};
...
struct UStaticMeshCarver : UDataAsset {
	...
	void Generate(); // Function FSDEngine.StaticMeshCarver.Generate // (Final|Native|Public|BlueprintCallable) // @ game+0x321ae20
	void ExportPreviewMesh(); // Function FSDEngine.StaticMeshCarver.ExportPreviewMesh // (Final|Native|Public|BlueprintCallable) // @ game+0x8dc380
};
