...
struct ABP_E3trailer_AsteroidField_C : AActor {
	...
	void UserConstructionScript(); // Function BP_E3trailer_AsteroidField.BP_E3trailer_AsteroidField_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x158ca90
};
