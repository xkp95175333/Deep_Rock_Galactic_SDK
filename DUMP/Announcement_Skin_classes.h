...
struct UAnnouncement_Skin_C : UUserWidget {
	...
	struct UBasic_Label_C* NameLabel; // 0x280(0x08)
	...
	void PreConstruct(bool IsDesignTime); // Function Announcement_Skin.Announcement_Skin_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x158ca90
	void Construct(); // Function Announcement_Skin.Announcement_Skin_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x158ca90
	void OnAnnounceAnimFinished(); // Function Announcement_Skin.Announcement_Skin_C.OnAnnounceAnimFinished // (BlueprintCallable|BlueprintEvent) // @ game+0x158ca90
	void ExecuteUbergraph_Announcement_Skin(int32_t EntryPoint); // Function Announcement_Skin.Announcement_Skin_C.ExecuteUbergraph_Announcement_Skin // (Final|UbergraphFunction) // @ game+0x158ca90
};
