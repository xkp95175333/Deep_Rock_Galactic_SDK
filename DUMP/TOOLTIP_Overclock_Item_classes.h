...
struct UTOOLTIP_Overclock_Item_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function TOOLTIP_Overclock_Item.TOOLTIP_Overclock_Item_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x158ca90
	void SetOverclock(struct UItemUpgrade* Overclock); // Function TOOLTIP_Overclock_Item.TOOLTIP_Overclock_Item_C.SetOverclock // (BlueprintCallable|BlueprintEvent) // @ game+0x158ca90
	void ExecuteUbergraph_TOOLTIP_Overclock_Item(int32_t EntryPoint); // Function TOOLTIP_Overclock_Item.TOOLTIP_Overclock_Item_C.ExecuteUbergraph_TOOLTIP_Overclock_Item // (Final|UbergraphFunction|HasDefaults) // @ game+0x158ca90
};
