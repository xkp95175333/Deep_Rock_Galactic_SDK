...
struct UITM_MenuBackground_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function ITM_MenuBackground.ITM_MenuBackground_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x158ca90
	void ExecuteUbergraph_ITM_MenuBackground(int32_t EntryPoint); // Function ITM_MenuBackground.ITM_MenuBackground_C.ExecuteUbergraph_ITM_MenuBackground // (Final|UbergraphFunction) // @ game+0x158ca90
};
